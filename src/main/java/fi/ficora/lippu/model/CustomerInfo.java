...
/**
 * Matkustajan vapaaehtoisesti antamat yhteystiedot esim. mahdollisen häiriötilanteen tiedotuksessa. HUOM, tietosuoja
 */
@ApiModel(description = "Matkustajan vapaaehtoisesti antamat yhteystiedot esim. mahdollisen häiriötilanteen tiedotuksessa. HUOM, tietosuoja")
@Validated
...
public class CustomerInfo   {
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Matkustajan nimi")
   ...
   * @return phone
  **/
  @ApiModelProperty(value = "Matkustajan puhelinnumero")
   ...
   * @return email
  **/
  @ApiModelProperty(value = "Matkustajan sähköpostiosoite")
