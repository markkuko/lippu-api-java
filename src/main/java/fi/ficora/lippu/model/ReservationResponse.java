...
import fi.ficora.lippu.model.ReservationResponseConfirmedReservations;
...
public class ReservationResponse   {
  ...
  public ReservationResponse caseId(String caseId) {
   ...
   /**
   * Toteutuneen transaktion asiatunniste esim. laskutuksen clearingiin
   * @return caseId
  **/
  @ApiModelProperty(value = "Toteutuneen transaktion asiatunniste esim. laskutuksen clearingiin")
