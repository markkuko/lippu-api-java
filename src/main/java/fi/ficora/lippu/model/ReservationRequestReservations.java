...
import fi.ficora.lippu.model.CustomerInfo;
...
public class ReservationRequestReservations   {
  ...
  public ReservationRequestReservations reservationData(String reservationData) {
   ...
   /**
   * Availability-vastauksessa olleen matkustusoikeuden varausdata.
   * @return reservationData
  **/
  @ApiModelProperty(value = "Availability-vastauksessa olleen matkustusoikeuden varausdata.")
  ...
  **/
  ...
  public ReservationRequestReservations addChosenExtraReservationDatasItem(String chosenExtraReservationDatasItem) {
   ...
   /**
   * Ostettujen lisäpalveluiden varausdata
   * @return chosenExtraReservationDatas
  **/
  @ApiModelProperty(value = "Ostettujen lisäpalveluiden varausdata")
